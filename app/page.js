        ...
        <section className="grid place-items-center">
            <div className="max-w-7xl w-full">
                <main className="flex min-h-screen flex-col items-center justify-center">
                    <section
                        className="absolute opacity-40 sm:opacity-50 bg-white bottom-2 filter h-full overflow-hidden md:w-full object-cover">
                    ...
                    <div className="flex bg-student w-fit m-2 mb-8 relative flex-col items-center">
                        <div className="w-fit relative flex flex-col items-center">
                            ...
                            <div
                                ...
                                By <a className={'text-blue-900'}
                                      href="https://futurespace.vercel.app">FutureSpace</a> and <a
                                className={'text-blue-900'} href="https://stevetom.vercel.app">KenTom</a>
                            </div>
                        </div>
                ...
                <div className="flex flex-col mt-8 sm:flex-row items-center justify-center overflow-clip w-full">
                    <div className="right w-full p-4 sm:p-6 md:p-8 sm:w-1/2">
                        ...
                        <p>
                            ...
                            platform simplifies the application process, enabling students to effortlessly explore and
                            apply
                            for opportunities. Simultaneously, it empowers employers to effortlessly discover and
                            recruit
                            top talent for their internship programs and attachment roles. With InternLink, connecting
                            the
                                ...
                                <svg className="w-24 top-6 absolute h-24">
                                    <defs>
                                        <linearGradient id="gradientStroke2" x1="0%" y1="100%" x2="0%" y2="0%">
                                            <stop offset="5%"
                                                  style={{stopColor: "rgb(74, 222, 128,0)", stopOpacity: 0}}/>
                                            <stop offset="70%"
            ...
            <div className={'footer mt-8 w-full md:mt-12'}>
                <Footer/>
            </div>
        </section>
    )
